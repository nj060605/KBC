...
print(" By Khushbu Jain" )

print("WELCOME TO KAUN BANEGA CROREPATI 2023....LET'S PLAY")

print("Hello", input("Enter Your Name\t"))

print(":::INSTRUCTIONS:::")
print(" This quiz consists of questions according to different levels and youcan use different lifelines also. ")
